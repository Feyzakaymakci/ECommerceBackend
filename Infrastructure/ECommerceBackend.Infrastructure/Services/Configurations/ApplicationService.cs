...
using Menu = ECommerceBackend.Application.DTOs.Configuration.Menu;

namespace ECommerceBackend.Infrastructure.Services.Configurations
{
    public class ApplicationService : IApplicationService
    {
        public List<Menu> GetAuthorizeDefinitionEndpoints(Type type)
        {
            Assembly assembly = Assembly.GetAssembly(type);  //Varolan assembly ye ulaşıp çalışan tüm classlara referanslara type lara ulaşabiliyoruz.
