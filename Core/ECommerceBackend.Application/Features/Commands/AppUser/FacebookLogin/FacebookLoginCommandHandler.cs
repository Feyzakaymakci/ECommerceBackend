...
namespace ECommerceBackend.Application.Features.Commands.AppUser.FacebookLogin
{
    public class FacebookLoginCommandHandler : IRequestHandler<FacebookLoginCommandRequest, FacebookLoginCommandResponse>
    {
        ...
        {
            string accesTokenResponse =await _httpClient.GetStringAsync($"https://graph.facebook.com/oauth/access_token?client_id=2473297539499443&client_secret=6fc0c972ac2d706164dd801222894e99&grant_type=client_credentials");
